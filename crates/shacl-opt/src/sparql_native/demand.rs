...
use shacl_algebra::{Path, Schema, Selector, Shape, ShapeId};
use spargebra::Query;
...
/// Convert a spargebra `PropertyPathExpression` to the `shacl_algebra::Path`
...
mod tests {
    ...
    fn algebra_demand_picks_up_count_paths() {
        use shacl_algebra::{NamedNode, NodeKindSet, ShapeArena, Statement};
