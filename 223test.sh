...
COMPILER_TRACK="${COMPILER_TRACK:-srcgen}"
COMPILER_BACKEND="${COMPILER_BACKEND:-specialized}"
...
echo "Compiling with compiler=$COMPILER_TRACK backend=$COMPILER_BACKEND ..."
compile_args=(
  --shapes-file "$SHAPES_FILE"
  --compiler "$COMPILER_TRACK"
